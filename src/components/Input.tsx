...
export const Input = ({ value, onChange, disabledMessage, disabled }: Props) => {
	...
	const hintValue = useMemo(() => (validateHeaderMax(value) ? '' : headerFieldOptions.message), [value]);
	...
	return (
		<div className='input-field-wrapper' data-testid='input-container'>
			<input
				...
				placeholder={disabled ? disabledMessage : `например, введите "купить молоко"`}
